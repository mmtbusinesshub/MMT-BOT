...
const groupaddplugin = require('./plugins/addgroup.js');
global.pluginHooks.push(groupaddplugin);
const ownerDetails = require('./plugins/owner.js');
global.pluginHooks.push(ownerDetails);
